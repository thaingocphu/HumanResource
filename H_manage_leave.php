...
require_once('db/db.php');
  ...
  function get_application() {
    $sql = "SELECT * FROM leave_app, account WHERE account.username = leave_app.username and role ='0' ";
		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="H_manage_leave.php">Leaves Management</a></li>
