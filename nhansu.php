<?php
  ...
  function get_user(){
    $sql = "SELECT * FROM account, department WHERE account.id_department = department.id_department";
    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
					...
					<li class="active"><a href="nhansu.php">Human Resources</a></li>
        ...
        <div class="col-md-2">
          <div class="dropdown create">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
              <li><a href="add_users.php">Add Employee</a></li>
