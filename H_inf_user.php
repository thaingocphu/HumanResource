		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="H_inf_user.php">Personal Information</a></li>
                ...
                <div class="col-md-2">
                    <div class="dropdown create">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <li><a href="H_change_password.php">Change Password</a></li>
                      </ul>
                    </div>
                  </div>
			</div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <img src="<?= $imagedefault ?>" alt="" id="profileDisplay" onClick="triggerClick()" />
                                    ...
                                    <form action="H_inf_user.php" enctype="multipart/form-data" method="POST">
